...
class College(models.Model):
    ...
    def __str__(self):
        return self.emp_id+";"+self.name+";"+self.gender+";"+self.email+";"+self.password+";"+self.college+";"+self.phone+";"+self.ques_1_id+";"+self.ans_1+";"+self.ques_2_id+";"+self.ans_2
...
class Transcations111(models.Model):
    userid=models.CharField(max_length=50)
    filename = models.CharField(max_length=50)
    date = models.DateTimeField(auto_now_add=True, blank=True)
    otp=models.CharField(max_length=100)
    access1 = models.CharField(max_length=50)
...
class FileCDN(models.Model):
    userid = models.CharField(max_length=50)
    filename = models.CharField(max_length=50)
    cdn=models.CharField(max_length=150)